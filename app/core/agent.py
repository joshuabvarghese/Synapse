...
_SYSTEM_PROMPT = (
    ...
    "search_kb may return entries for a different service than the one you're "
    "investigating — only the closest, evidently-relevant match should inform your "
    "answer. Do not blend in details (config, commands, policies) from an unrelated "
    "service's incident just because it appeared in the results.\n\n"
